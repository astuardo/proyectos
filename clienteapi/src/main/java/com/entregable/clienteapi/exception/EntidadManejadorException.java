...
public class EntidadManejadorException {

    @ExceptionHandler(value = {EntidadNoEncontradoException.class})
    @ResponseStatus(code = HttpStatus.NOT_FOUND)
    public NoStockMensaje clienteNoEncontrado(EntidadNoEncontradoException ex,
                                              WebRequest request) {
